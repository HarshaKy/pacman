...
#         for f in food:
#             distance = self.distance(pacman, f)
...
#     def distance(self, pacman, food):
#         return abs(pacman[0] - food[0]) + abs(pacman[1] - food[1])
    
#     def direction(self, pacman, nearestFood, walls, state):
#         legal = api.legalActions(state)
#         if pacman[0] < nearestFood[0] and Directions.EAST in legal and not walls[pacman[0] + 1][pacman[1]]:
#             return api.makeMove(Directions.EAST, legal)
#         elif pacman[0] > nearestFood[0] and Directions.WEST in legal and not walls[pacman[0] - 1][pacman[1]]:
#             return api.makeMove(Directions.WEST, legal)
#         elif pacman[1] < nearestFood[1] and Directions.NORTH in legal and not walls[pacman[0]][pacman[1] + 1]:
#             return api.makeMove(Directions.NORTH, legal)
#         elif pacman[1] > nearestFood[1] and Directions.SOUTH in legal and not walls[pacman[0]][pacman[1] - 1]:
#             return api.makeMove(Directions.SOUTH, legal)
#         else:
